create_data_frame <- function(zone_calculated_list) {
  ...
  message("   • Generate normalized lineplot, vibration/rest boxplot, and delta boxplot datasets")
  ...
  vibration_period <- get_input_local(
    "vibration_period",
  ...
  calculate_means <- function(var) {
    all_zone_combined %>% 
      filter(period_with_numbers %in% c(vibration_period, rest_period)) %>%
  ...
  message("🔄 Generating vibration/rest boxplot dataset...")
  all_zone_combined_vibration_rest_boxplots <- setNames(lapply(response_vars, calculate_means), response_vars)
  message("✔️ all_zone_combined_vibration_rest_boxplots created.")
  ...
  assign("all_zone_combined_vibration_rest_boxplots", all_zone_combined_vibration_rest_boxplots, envir = .GlobalEnv)
  ...
  message("    - 'all_zone_combined_vibration_rest_boxplots': boxplot data for vibration/rest periods")
