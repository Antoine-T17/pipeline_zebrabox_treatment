...
# It standardizes numeric column conversion and saves the data globally as 'extracted_data_df'.
# -----------------------------------------------------------
extract_data <- function() {
  ...
  message("   • Your raw data file is in 'inputs/tracking_mode/light_dark_mode/raw_data'.")
  ...
  # Step 4: Prompt for the raw data file name
  ...
  # Step 5: Build the full path and validate file existence
